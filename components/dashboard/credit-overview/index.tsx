...
import type { ICreditChartData } from "@/services/dashboard/types";

interface Props {
  data: ICreditChartData;
}
...
// Helper to get current week's date for a specific day
...
export function CreditOverview({ data }: Props) {
  ...
  return (
    <Card className="rounded-2xl border py-4 border-gray-200 shadow-[0px_0px_6px_rgba(0,0,0,0.06)]">
      <CardHeader className="flex flex-row items-center justify-between px-5 space-y-0 pb-0">
        <CardTitle className="text-gray-800 dark:text-white">Credit</CardTitle>
